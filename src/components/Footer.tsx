    ...
    <div className="bg-[#031E2F] z-0 opacity-100 p-7 sm:px-16 lg:px-32 flex flex-col gap-4">
      <div className="w-full mx-auto px-6 grid sm:grid-cols-2 grid-cols-1 gap-7">
        ...
        <div className="flex flex-col">
          ...
          &nbsp;    </li>
            <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
                  090-900-0671 ( Mr. Jinno )            </li>
            <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
                  0903-824-785 (Vietnamese)            </li>
            <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
            E-mail : anri-info @jinno.co.jp           </li>
            <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
            • Head Office: Charmington La Pointe Bldg.Block B, 8-3A           </li>
            <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
            181 Cao Thang Str., 12 Ward, Dist.10, Ho Chi Minh City, 72510, Vietnam           </li>
            <li className="my-2 hover:text-orange-500 cursor-pointer transition-all">
            • Ha Noi Rep. Office V-Tower Bldg.302 649 Kim Ma Str., Ba Dinh Dist., Ha Noi City, 11112, Vietnam </li>

            <li className="my-3 hover:text-orange-500 cursor-pointer transition-all">
